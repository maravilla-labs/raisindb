  ...
  useEffect(() => {
    ...
    integrationsApi
      ...
      .then((s) => {
        ...
        if (s.base_url_configured && s.oauth_redirect_uri) setRedirectUri(s.oauth_redirect_uri)
      })
      .catch(() => {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="https://host/api/integrations/{repo}/oauth/callback"
                />
              </div>
              <div>
          ...
          {current?.path && (
            <div className="border border-white/10 rounded-lg p-4 space-y-3">
              ...
              <TestConnectionPanel
                repo={repo}
                request={{ integration_path: current.path }}
