...
-- Tagged-with relations (articles to tags)
-- These enable graph queries like "find all articles with a specific tag"
-- or "find articles that share tags"

-- Rust article tags
RELATE FROM path='/superbigshit/articles/tech/rust-web-development-2025' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/tech-stack/rust' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/tech/rust-web-development-2025' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/tech-stack/web' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/tech/rust-web-development-2025' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/trending' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;

-- AI coding article tags
RELATE FROM path='/superbigshit/articles/tech/ai-coding-assistants' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/tech-stack/ai' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/tech/ai-coding-assistants' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/trending' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/tech/ai-coding-assistants' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/audience/beginners' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;

-- TypeScript article tags
RELATE FROM path='/superbigshit/articles/tech/typescript-5-features' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/tech-stack/typescript' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/tech/typescript-5-features' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/tech-stack/web' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/tech/typescript-5-features' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/audience/advanced' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;

-- Startup funding article tags
RELATE FROM path='/superbigshit/articles/business/startup-funding-guide' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/trending' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/business/startup-funding-guide' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/audience/enterprise' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/business/startup-funding-guide' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/analysis' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;

-- Remote work article tags
RELATE FROM path='/superbigshit/articles/business/remote-work-trends' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/analysis' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/business/remote-work-trends' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/audience/enterprise' IN WORKSPACE 'social'
...
-- Olympics article tags
RELATE FROM path='/superbigshit/articles/sports/olympic-preview-2028' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/trending' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/sports/olympic-preview-2028' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/breaking' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;

-- Esports article tags
RELATE FROM path='/superbigshit/articles/sports/esports-mainstream' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/analysis' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/sports/esports-mainstream' IN WORKSPACE 'social'
...
RELATE FROM path='/superbigshit/articles/entertainment/music-ai-revolution' IN WORKSPACE 'social'
  ...
  TYPE 'tagged-with' WEIGHT 1.0;
RELATE FROM path='/superbigshit/articles/entertainment/music-ai-revolution' IN WORKSPACE 'social'
  TO path='/superbigshit/tags/topics/opinion' IN WORKSPACE 'social'
  TYPE 'tagged-with' WEIGHT 1.0;
