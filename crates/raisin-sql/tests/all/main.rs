//! All `raisin-sql` integration tests, compiled into ONE binary.
//!
...
//!
//! ```bash
//! cargo test -p raisin-sql --test all <module>
//! cargo test -p raisin-sql --test all <module>::<test_name>
//! ```
//!
