//! All `raisin-cypher-parser` integration tests, compiled into ONE binary.
//!
...
//!
//! ```bash
//! cargo test -p raisin-cypher-parser --test all <module>
//! cargo test -p raisin-cypher-parser --test all <module>::<test_name>
//! ```
//!
