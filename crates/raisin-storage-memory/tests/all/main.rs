//! All `raisin-storage-memory` integration tests, compiled into ONE binary.
//!
...
//!
//! ```bash
//! cargo test -p raisin-storage-memory --test all <module>
//! cargo test -p raisin-storage-memory --test all <module>::<test_name>
//! ```
//!
